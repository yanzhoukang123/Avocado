...
namespace Azure.ScannerEUI.ViewModel
{
    ...
    class Workspace : ViewModelBase, IDisposable
    {
        ...
        private bool _EnabledFlag = true;
        ...
        private bool _LoginStatus = false;        //登录状态  Login status
        ...
        private bool _DeviceStatus = true;
        private string _DefaultHWversion = "1.1.0.0";  
        private const string defaultPassword = "admin";   //Login box default password
                ...
                switch (Name)
                {
                    case "L":
                        if (ScanImage)
                        {
                            ...
                            //if (SettingsManager.ConfigSettings.AllModuleProcessing)//Average two rows of data to one row
                            //{
                            //       FileViewModel.AverageTwoRowstoOneRowsProcessing(ref image);
                            //}
                        }
                        break;
                    case "R1":
        ...
        public ICommand LoginCommand
        {
            get
            {
                ...
                {
                    _LoginCommand = new RelayCommand(this.ExecuteLoginCommand, this.CanExecuteLoginCommand);
                }
        ...
        protected void ExecuteLoginCommand(object parameter)
        {
            ...
            {
                //Entering MainWindow when LoginStatus is true
                LoginStatus = true;
            }
            else
            {
        ...
        //Enter Login
        public void EnterExecuteLoginCommand()
        {
            if (string.IsNullOrEmpty(Password))
            {
                MessageBox.Show("Please input password");
        ...
        protected bool CanExecuteLoginCommand(object parameter)
        {
            return true;
        }
        #endregion
        ...
        private void LoadInitSplashScreen()
        {
            try
            {
                Owner.Dispatcher.Invoke((Action)delegate
                {
                    ...
                    {
                        //Hide and enter the MainWindow progress form, display the Login form
                        //隐藏进入MainWindow进度窗体,显示Login窗体
                        ...
                        Thread.Sleep(200);
                        //Hide the Login form and display the MainWindow progress form
                        //隐藏Login窗体,显示MainWindow进度窗体
        ...
        public bool EnabledFlag
        {
            ...
            set
            {
                ...
                {
                    _EnabledFlag = value;
                    RaisePropertyChanged("EnabledFlag");
                }
            }
        }
