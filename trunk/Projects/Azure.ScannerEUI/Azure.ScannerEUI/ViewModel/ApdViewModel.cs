    ...
    class ApdViewModel : ViewModelBase
    {
        ...
        public bool? TopCoverLock
        {
            ...
            set
            {
                ...
                {
                    _TopCoverLock = value;
                    if (_TopCoverLock == true)
                    {
                        Workspace.This.TopCoverLockStatus = true;
                    }
                    else
                    {
                        Workspace.This.TopCoverLockStatus = false;
                    }
                }
            }
        }
        ...
        public bool? TopMagneticState
        {
            ...
            set
            {
                if (_TopMagneticState != value)
                {
                    ...
                    if (_TopMagneticState == true)
                    {
                        Workspace.This.TopMagneticStatus = true;
                    }
                    else
                    {
                        Workspace.This.TopMagneticStatus = false;
                    }
                }
            }
        }
        ...
        public bool? OpticalModulePowerMonitor
        {
            ...
            set
            {
                if (_OpticalModulePowerMonitor != value)
                {
                    ...
                    if(_OpticalModulePowerMonitor == true)  // optical module power is on
                    {
                        // let LED bar to beep
