...
namespace Azure.Avocado.EthernetCommLib
{
    ...
    public class EthernetController
    {
        ...
        public bool ShutdownDuringScanStatus { get { return AvocadoProtocol.ShutdownDuringScanStatus; }  //State when pressing the front panel button while scanning images  （FW Version 1.1.0.0）  //扫描图像时按下前面板按钮时的状态
            set
            {
